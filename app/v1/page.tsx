...
import { ArrowUpRight, Sunrise, Waves, MapPin, Mail, Instagram, Coffee, Sun } from "lucide-react";

const heroImg = "/assets/hero-sunrise.jpg";
const runningImg = "/assets/running.jpg";
const hiitImg = "/assets/hiit.jpg";
const swimImg = "/assets/swim.jpg";
const teamImg = "/assets/team.jpg";
...
export const metadata: Metadata = {
  ...
  description: "Yoga, running, natation, HIIT au lever du soleil à Marseille. Sessions sportives conviviales et team building face à la Méditerranée.",
  openGraph: {
    title: "Marseille Good Waves",
    description: "Sport au lever du soleil sur la plage des Catalans. Yoga, running, natation, HIIT et petit-déj face à la mer.",
    images: ["/assets/hero-sunrise.jpg"],
  },
};
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      <div className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 text-background mix-blend-difference">
...
function Marquee() {
  ...
  return (
    <div className="bg-gradient-sunrise overflow-hidden py-4 shadow-[inset_0_2px_12px_oklch(1_0_0_/_0.25)]">
      <div
      ...
      >
        {row.map((w, i) => (
          <span
            key={i}
            className="font-sans text-base md:text-2xl font-extrabold uppercase tracking-tight text-foreground flex items-center gap-8"
          >
            {w}
            <Sun className="size-3.5 md:size-5 text-foreground/55" strokeWidth={2.5} />
          </span>
        ))}
      </div>
    </div>
